...
describe('GET /api/v1/legislation/recent', () => {
  ...
  it('returns recent bills payload with cache headers', async () => {
    ...
    getBillsMock.mockResolvedValue({
      bills: [{ number: '1', type: 'HR', congress: 119, title: 'Bill', updateDate: '2026-02-08', updateDateIncludingText: '2026-02-08', originChamber: 'House', introducedDate: '2026-01-01', url: '/bill/1' }],
      pagination: { count: 1 },
    })
