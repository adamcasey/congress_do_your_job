    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="border-b border-slate-200">
        <div className="max-w-3xl mx-auto px-6 py-10">
          <Link
            href="/"
            className="text-sm text-slate-500 hover:text-slate-800 transition-colors mb-6 inline-block"
          >
            ← Back to home
          </Link>
          ...
          <p className="mt-3 text-slate-600 text-lg leading-relaxed">
            Our Civility &amp; Productivity Scorecards are calculated entirely from verifiable
            public records. Every formula, weight, and data source is documented here.
          </p>
      ...
      <div className="max-w-3xl mx-auto px-6 py-12 space-y-16">
        ...
        <section>
          ...
          <ul className="space-y-3 text-slate-600">
            <li className="flex gap-3">
              ...
              <span>
                <strong className="text-slate-800">Verifiable only.</strong> Every data point
                can be traced to an official government record. We score what legislators DO,
                not what they say.
              </span>
            </li>
            <li className="flex gap-3">
              <span className="text-slate-300 mt-0.5">—</span>
              <span>
                <strong className="text-slate-800">Non-partisan.</strong> Methodology never
                references party affiliation as a factor in scoring. We measure bipartisanship
                as a positive behavior, not partisanship as a negative one.
              </span>
            </li>
            <li className="flex gap-3">
              <span className="text-slate-300 mt-0.5">—</span>
              <span>
                <strong className="text-slate-800">Human review required.</strong> All
                sentiment analysis, promise tracking, and media interpretation is reviewed
                by our editorial team before publication. No automated scoring of speech content.
              </span>
            </li>
            <li className="flex gap-3">
              <span className="text-slate-300 mt-0.5">—</span>
              <span>
                <strong className="text-slate-800">Transparent methodology.</strong> Every
                change to the scoring algorithm is version-controlled and publicly documented.
              </span>
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="text-slate-600 mb-5">
            The overall score is a weighted sum of six categories. Weights reflect the
            relative importance of each activity to the core job of legislating.
          </p>
        ...
        <section>
          ...
          <div className="rounded-2xl border border-amber-200 bg-amber-50 p-6 text-sm text-amber-900 space-y-3">
            <p>
              <strong>Partial data during early operation.</strong> Categories without live
              data sources (committee attendance, civility, theater ratio) use neutral defaults
              until connections are established. Each scorecard displays a data source transparency
              report showing which categories are live, partial, or using defaults.
            </p>
            <p>
              <strong>Not a complete picture.</strong> Constituent casework, private negotiations,
              and informal cross-aisle collaboration are difficult to quantify. This scorecard
              measures what can be verified from public records, not every aspect of an
              official's work.
            </p>
            <p>
              <strong>Corrections welcome.</strong> If you believe a score contains an error,
              use the community correction form. All corrections are reviewed with supporting
              evidence before any change is made.
            </p>
          </div>
        </section>
