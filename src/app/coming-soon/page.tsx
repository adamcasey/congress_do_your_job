...
export default function ComingSoon() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#e4f0f9] via-[#e4f0f9] to-[#fde3e0]">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-5xl flex-col justify-center px-4 sm:px-6 py-6">
        <header className="mb-10 text-center">
          {showBudgetTimer && <BudgetCountdown />}
          <div className="flex flex-col items-center justify-center gap-3 text-slate-800">
            <h1
              className={`${freePressFont.className} text-3xl leading-none tracking-tight text-slate-900 sm:text-5xl md:text-6xl lg:text-7xl`}
            >
        ...
        <section className="mx-auto grid max-w-5xl gap-10 rounded-[28px] bg-white/80 p-6 sm:p-10 shadow-2xl shadow-amber-100/40 ring-1 ring-amber-100/70 md:items-center">
