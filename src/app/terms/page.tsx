        ...
        <article className="prose prose-slate max-w-none">
          ...
          <div className="mt-8 space-y-6 text-slate-700">
            <section>
              ...
              <p>
                By accessing or using Congress Do Your Job (&quot;the Service&quot;), you agree to be bound by these
            ...
            <section>
              ...
              <p>
                When you create an account, you are responsible for maintaining the security of your account and all
                activities that occur under it. You must provide accurate and complete information.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                All content, design, graphics, and data compilations on Congress Do Your Job are owned by us or our
                licensors and protected by copyright and other intellectual property laws.
              </p>

              <h3 className="text-xl font-semibold text-slate-900">Public Data Sources</h3>
              <p>
                Legislative data, voting records, and other government information are sourced from public APIs and
                databases. We provide links to original sources.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                When you send letters or sign petitions through our Service, you acknowledge that:
              </p>
              <ul>
            ...
            <section>
              ...
              <p>
                Information provided is for educational purposes only and does not constitute legal, political, or
                professional advice.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                To the maximum extent permitted by law, Congress Do Your Job shall not be liable for any indirect,
            ...
            <section>
              ...
              <p>
                These terms are governed by the laws of the United States and the state where Congress Do Your Job is
